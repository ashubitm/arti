...
public class TwitterIntoCouchbase {
	...
	public static void main(String[] args) throws Exception {
		...
		ParameterTool params = ParameterTool.fromPropertiesFile("C:\\Users\\SONY VAIO\\Documents\\GitHub\\TwitterToCouchbaseFlink\\src\\main\\resources\\twitter.properties");
		
		CouchbaseSink cbsink =new CouchbaseSink(params.get("clusterUri"), params.get("user"), params.get("password"), params.get("bucketName"));
