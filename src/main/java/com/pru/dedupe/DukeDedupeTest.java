...
import com.pru.data.streams.WriteJSONtoFile;
...
public class DukeDedupeTest 
{
    public static void dukeDedupe()
    {
    	try {
    	InMemoryDataSource source1 = new InMemoryDataSource() ;
    	  InMemoryDataSource source2 = new InMemoryDataSource();
 //   	  TestUtils listener;
    	  String array[]= {"aaaaa","bbbbb"};
    	  //TODO this will take the stream and form the json
    	  
    	//  WriteJSONtoFile.writeToFile(array);
    	  
    	String path = "C:\\Users\\SONY VAIO\\eclipse-workspace\\arti\\src\\config-database.xml";
