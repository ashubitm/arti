...
public class StreamTransformationEngine2 {
...
//Call couchbase Database		- already tested 
		String oper_mode ="CREATE";
		CouchBaseJavaConnect couchbaseDb = new CouchBaseJavaConnect();
		
	//	couchbaseDb.callCouchbaseDb(oper_mode,jsonObj);
